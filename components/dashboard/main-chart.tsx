  ...
  return (
    <Card className="flex flex-col h-full">
      ...
      <CardFooter className="flex flex-col sm:flex-row gap-2 justify-end">
        <Button className="w-full sm:w-auto sm:flex-1" onClick={() => onTrade('buy')}>Buy</Button>
        <Button
          variant="outline"
        ...
        <Button className="w-full sm:w-auto sm:flex-1" variant="outline" onClick={() => onTrade('sell')}>Sell</Button>
      </CardFooter>
    </Card>
  );
}
